"""
app/shared/utils/constants_messages.py
Here i will keep the constants messages here
...
I will need  to make instance of these and then use those instance.attributes
"""
