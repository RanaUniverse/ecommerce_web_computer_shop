"""
app/features/catalog/operations/product.py
...
def delete_one_product_row_by_id(
    session: Session,
    product_id: str,
) -> bool:
    """
...
def get_product_info_by_id(
    ...
    """
    i will pass the product id and it will give me the model obj
    """
    obj = session.get(
        ProductModel,
        product_id,
